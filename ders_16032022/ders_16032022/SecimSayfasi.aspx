<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="SecimSayfasi.aspx.cs" Inherits="ders_16032022.WebForm6" %>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-3">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <asp:Button ID="Button2" runat="server" Text="Ara" CssClass="btn btn-primary" OnClick="Button2_Click" />
                                    </div>
                                </div>
                ...
                <br />
                <asp:Button ID="Button1" runat="server" Text="Arama Yap" CssClass="btn btn-primary" OnClick="Button1_Click" />
            </div>
            <div class="col-9">
                <div class="row">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    <asp:Button ID="Button1" runat="server" Text="Seç" CssClass="btn btn-outline-primary" OnClick="Button1_Click" />
                                                </p>
                                            </div>
                                        </div>
                                    </div>

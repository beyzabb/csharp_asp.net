...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-3">
                <asp:Label ID="Label1" runat="server" Text="Alış Tarihi"></asp:Label>
            ...
            <div class="col-3">
                <asp:Label ID="Label5" runat="server" Text="Tabi ki bizi tercih et" Visible="false"></asp:Label>
                <br />
                <asp:Button ID="btn_enuygunaraciBul" runat="server" Text="En Uygun Aracı Bul" CssClass="btn btn-warning" OnClick="btn_enuygunaraciBul_Click"/>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-3">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <asp:Label ID="lbl_cizgi" runat="server" Text=" _ "></asp:Label>
                                    </div>
                                    <div class="col-4">
                                        <asp:TextBox ID="txt_max" runat="server" CssClass="form-control" placeholder="max"></asp:TextBox>
                                    </div>
                                    <div class="col-3">
                                        <asp:Button ID="btn_araKucuk" runat="server" Text="Ara" CssClass="btn btn-outline-success" OnClick="btn_araKucuk_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <br />
                <asp:Button ID="btn_ara" runat="server" Text="Arama Yap" CssClass="btn btn-success" OnClick="btn_araKucuk_Click" />
            </div>
            <div class="col-9">
                <div class="row">

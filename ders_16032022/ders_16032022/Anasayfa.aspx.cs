    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                rpter_yakit.DataSource = vt.yakitListele();
                rpter_yakit.DataBind();

                rpter_araclar.DataSource = vt.FiloGoruntule();
                rpter_araclar.DataBind();

                DropDownList1.DataSource = vt.alanListele();
                DropDownList1.DataTextField = "aciklama";
        ...
        protected void btn_araKucuk_Click(object sender, EventArgs e)
        {
        ...
        protected void btn_enuygunaraciBul_Click(object sender, EventArgs e)
        {
